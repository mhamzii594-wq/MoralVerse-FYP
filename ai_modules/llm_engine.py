...
def _generate_video_prompts_for_scenes(
    ...
    system = (
        ...
        "  - Cinematic detail (use sparingly, only when physically motivated): shallow depth of field, "
        "soft bokeh, volumetric god-rays through leaves, gentle parallax of background, dust motes in light. "
        "These add cinematic feel without introducing motion the model can't render reliably.\n"
